...
int detect(char *model_path, char *image_path, char *save_image_path)
{
    ...
    GetResultRectYoloworld PostProcess;
    ...
    for (int i = 0; i < DetectiontRects.size(); i += 6)
    {
        ...
        rectangle(orig_img, cv::Point(xmin, ymin), cv::Point(xmax, ymax), cv::Scalar(255, 0, 0), 2);
        putText(orig_img, text1, cv::Point(xmin, ymin + 15), cv::FONT_HERSHEY_SIMPLEX, 0.7, cv::Scalar(0, 0, 255), 2);
    }

    imwrite(save_image_path, orig_img);
...
{
    char model_path[256] = "/home/firefly/zhangqian/workspace/rknpu2/examples/rknn_2.0_yoloworld_demo/model/RK3588/yolo_world_v2.rknn";
    char image_path[256] = "/home/firefly/zhangqian/workspace/rknpu2/examples/rknn_2.0_yoloworld_demo/test.jpg";
    char save_image_path[256] = "/home/firefly/zhangqian/workspace/rknpu2/examples/rknn_2.0_yoloworld_demo/test_result.jpg";
